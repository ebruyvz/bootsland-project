export default function Benefits() {
    return (
      <ul className="pt-16 md:flex md:flex-wrap md:justify-between px-[50px]">
        <li className="bg-white shadow-2xl w-[400px] p-12 mb-14 md:w-[50vh]">
        ...
        <li className="mb-7 hover:bg-white hover:shadow-2xl hover:animate-[up_1s] mt-8 w-[400px] p-12 text-center md:w-[50vh]">
        ...
        <li className="bg-white shadow-2xl w-[400px] p-12 text-right mb-12 md:w-[50vh]">
